var emailIdOrPhno=localStorage.getItem("maiIdOrPhno")
...
function passVis()
{
  ...
  document.getElementById("passvis").src="../Asset/Images/monkey openeyes.png"
  document.getElementById("passvis").style.transform="rotateY(180deg)"
}
function passHid()
{
  form[0].elements[1].type="password"
  document.getElementById("pass").style.transition="transform 0.3s"
  document.getElementById("passvis").style.transform="rotateY(0deg)"
  document.getElementById("passvis").src="./Asset/Images/closedeye monkey.png"
}
function bigButton()
{
